    ...
    <div class="custom-container">
        <div v-if="isStripeSuccess" class="static-page-wrapper stripeSuccess">
            <div class="header-wrapper">
                ...
                <h1 v-if="successTranslationKey != null">
                    {{ $t(`donation.${successTranslationKey}success.title`) }}
                </h1>
            ...
            <div
                v-if="successTranslationKey != null"
                v-html-md="
                    $t(`donation.${successTranslationKey}success.description`)
                "
            />
        ...
        <div v-else class="static-page-wrapper donation">
            ...
            <div>
                ...
                <div class="paymentMethod">
                    ...
                    />
                    <div
                        v-html-md="$t('donation.monthly.stripe.description')"
                    />
                    <div class="stripeCheckout">
                        ...
                        />
                        <span
                            v-for="item in stripeSubscriptions"
                            :key="item.price"
                        >
                            <button @click="submitSubscription(item)">
                                {{
                                    $t('donation.monthly.stripe.donateButton', {
                ...
                <div v-if="language == 'sl'" class="paymentMethod">
                    ...
                    <div
                        v-html-md="
                            $t(
                                'donation.monthly.permanentBankTransferOrder.description'
                            )
                        "
                    />
                    <div class="stripeCheckout">
                        <span>
                            <button
                                @click="
                                    showPermanentBankTransferOrderDetails =
                                        !showPermanentBankTransferOrderDetails
                                "
                            >
                                {{
                                    $t(
                                        'donation.monthly.permanentBankTransferOrder.detailsButton'
                                    )
                                }}
                            </button>
                        </span>
                    ...
                    <div v-if="showPermanentBankTransferOrderDetails">
                        <table class="bankDetails">
                            <tr>
                                <td>
                                    {{ $t('donation.bankDetails.recipient') }}
                                </td>
                                <td>
                                    Znanstveno društvo Sledilnik
                                    <br />Celovška cesta 111 <br /><span
                                        v-if="language != 'sl'"
                                        >1000 </span
                                    >Ljubljana
                            ...
                            <tr>
                                <td>
                                    {{ $t('donation.bankDetails.purposeCode') }}
                                </td>
                                <td>CHAR</td>
                            </tr>
                            <tr v-if="language == 'sl'">
                                <td>
                                    {{ $t('donation.bankDetails.purpose') }}
                                </td>
                                <td>Donacija</td>
                            </tr>
                            <tr v-if="language == 'sl'">
                                <td>
                                    {{ $t('donation.bankDetails.reference') }}
                                </td>
                                <td>SI99</td>
                            </tr>
                            <tr v-if="language != 'sl'">
                                <td>
                                    {{
                                        $t('donation.bankDetails.bankBicSwift')
                                    }}
                                </td>
                                <td>HDELSI22</td>
                            </tr>
            ...
            <div>
                ...
                <div class="paymentMethod">
                    ...
                    <div
                        v-html-md="
                            $t('donation.onetime.banktransfer.description')
                        "
                    />
                    <div class="stripeCheckout">
                        <span>
                            ...
                            >
                                {{
                                    $t(
                                        'donation.onetime.banktransfer.detailsButton'
                                    )
                                }}
                            </button>
                        </span>
                    ...
                    <div v-if="showBanktransferDetails">
                        <img
                            v-if="language == 'sl'"
                            src="../assets/donate/donate-qr.png"
                            class="qr"
                        />
                        <table class="bankDetails">
                            <tr>
                        ...
                        <img
                            v-if="language == 'sl'"
                            src="../assets/donate/donate-upn.png"
                            class="upn"
                        />
                    </div>
                </div>
                ...
                <div class="paymentMethod">
                    ...
                    />
                    <div
                        v-html-md="$t('donation.onetime.stripe.description')"
                    />
                    <div class="stripeCheckout">
                        <stripe-checkout
                        ...
                        />
                        <span
                            v-for="item in stripeOneTimeDonations"
                            :key="item.price"
                        >
                            <button @click="submitOneTimeDonation(item)">
                                {{ item.amount + ' EUR' }}
                            </button>
                        </span>
                    </div>
                ...
                <div
                    v-if="language == 'sl'"
                    class="paymentMethod smsDetails"
                    id="sms"
                >
                    <font-awesome-icon
                        icon="mobile-alt"
                    ...
                    />
                    <img
                        :src="smsQrImage(this.smsAmount)"
                        @click="triggerSms()"
                        class="smsqr"
                    />
                    <div
                        v-html-md="
                            $t('donation.onetime.sms.description', {
                                amount: this.smsAmount + ' EUR',
                                number: this.smsNumber,
                                keyword: this.smsKeyword + this.smsAmount,
                            })
                        "
                    ></div>
                    <div class="stripeCheckout">
                        <span>
                            <button @click="triggerSms()">
                                {{ this.smsAmount + ' EUR' }}
                            </button>
                        </span>
                    </div>
                ...
                <div
                    v-if="language == 'sl'"
                    class="paymentMethod mbillsDetails"
                    id="mbills"
                >
                    <img
                        src="../assets/donate/mbills_logo_bw.svg"
                        alt="mbills"
                        class="mbillsLogo"
                    />
                    <div
                        v-html-md="$t('donation.onetime.mbills.description')"
                        class="description"
                    ></div>
                    <div class="stripeCheckout">
                        <span>
                            <button
                                @click="showMbillsDetails = !showMbillsDetails"
                            >
                                {{
                                    $t('donation.onetime.mbills.detailsButton')
                                }}
                            </button>
                        </span>
                    </div>
                    <div v-if="showMbillsDetails">
                        <a
                            href="mbills://www.mbills.si/dl/?type=2&amp;qritemid=298757"
                        >
...
export default {
    ...
    methods: {
        ...
        smsQrImage(amount) {
            ...
            return images(
                `./sms-${this.smsNumber}-${this.smsKeyword}${amount}.png`
            )
        },
    },
}
