  ...
  <div>
    ...
    <div class="visualizations container">
      <section id="published-chart">
        ...
        <div
          class="disclaimer"
          v-html-md="$t('charts.ostanizdrav.published.description')"
        ></div>
      </section>
      <section id="usercount-chart">
        ...
        <div
          class="disclaimer"
          v-html-md="$t('charts.ostanizdrav.usercount.description')"
        ></div>
      </section>
      <section id="userPublishedByCount">
        ...
        <div
          class="disclaimer"
          v-html-md="$t('charts.ostanizdrav.userPublishedByCount.description')"
        ></div>
      </section>
      <section id="publishedByRisk-chart">
        ...
        <div
          class="disclaimer"
          v-html-md="$t('charts.ostanizdrav.publishedByRisk.description')"
        ></div>
      </section>
      <section id="valid-chart">
        ...
        <div
          class="disclaimer"
          v-html-md="$t('charts.ostanizdrav.valid.description')"
        ></div>
      </section>
