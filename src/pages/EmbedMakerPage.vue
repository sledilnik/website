...
export default {
    data() {
        return {
            ...
            baseEmbedUrl:
                location.origin + '/embed.html#/' + this.$i18n.i18next.language,
            charts: {
                empty: {
                    value: null,
                ...
                DailyComparison: {
                    ...
                    text: this.$t('charts.dailyComparison.title', {
                        context: process.env.VUE_APP_LOCALE_CONTEXT,
                    }),
                    dimensions: [1140, 720],
                },
                EuropeMap: {
