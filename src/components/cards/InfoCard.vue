        ...
        <div class="hp-card" :class="{ outdated }" v-if="!loading">
            ...
            <div class="card-number">
                <span
                    ...
                    }}<span class="card-number-extra" v-if="valueExtraText">
                        {{ valueExtraText | percent }}</span
                    ></span
                >
                <div
            ...
            <div :id="cardName" class="card-diff">
                <div v-if="cardData.subTitle">
                    <span class="card-note"
                        >{{ cardData.subTitle }}
                        <span>{{ subLabelExtraText }}</span></span
                    >
                </div>
                <div
                ...
                >
                    <div
                        class="trend-icon in"
                        :class="[
                            cardData.flipGoodDirection ? 'good up' : 'bad up',
                        ]"
                    ></div>
                    <span
                        class="in"
                        :class="[cardData.flipGoodDirection ? 'good' : 'bad']"
                        >{{ cardData.subValues.in | number }}</span
                    >
                </div>
                <div
                ...
                >
                    ...
                    <span class="positive bad">{{
                        cardData.subValues.positive | number
                    }}</span>
                </div>
                <div
                ...
                >
                    ...
                    <span class="percent tests">{{
                        cardData.subValues.percent | number
                    }}</span>
                </div>
            </div>
    ...
    computed: {
        ...
        percentageDirection() {
            if (this.cardData.diffPercentage === 0) {
                ...
                this.cardData.diffPercentage > 0 &&
                !this.cardData.reverseGoodDirection
            ) {
                return 'bad'
            }
            return 'good'
...
.hp-card {
    ...
    &.outdated {
        ...
        > div.card-number {
            -webkit-filter: grayscale(100%) blur(2px) contrast(110%);
            filter: grayscale(100%) blur(2px) contrast(110%);
        }
    }
...
.trend-icon {
    ...
    &.down {
        -webkit-mask: url(../../assets/svg/close-circle-down.svg) no-repeat
            center;
    ...
    &.positive {
        -webkit-mask: url(../../assets/svg/close-circle-plus.svg) no-repeat
            center;
    ...
    &.percent {
        -webkit-mask: url(../../assets/svg/close-circle-percent.svg) no-repeat
            center;
