<template>
    ...
    >
        ...
        <div class="nav-links">
            ...
            <router-link :to="{ name: 'stats' }" class="router-link"
                ><span>{{ $t('navbar.home') }}</span></router-link
            >
            <router-link :to="{ name: 'world' }" class="router-link"
                ><span>{{ $t('navbar.world') }}</span></router-link
            >
            <router-link :to="{ name: 'data' }" class="router-link"
                ><span>{{ $t('navbar.data') }}</span></router-link
            >
            <router-link :to="{ name: 'models' }" class="router-link"
                ><span>{{ $t('navbar.models') }}</span></router-link
            >
            <router-link :to="{ name: 'posts' }" class="router-link"
                ><span>{{ $t('navbar.posts') }}</span></router-link
            >
            <router-link :to="{ name: 'faq' }" class="router-link"
                ><span>{{ $t('navbar.faq') }}</span></router-link
            >
            <router-link :to="{ name: 'about' }" class="router-link"
                ><span>{{ $t('navbar.about') }}</span></router-link
            >
            <router-link :to="{ name: 'donate' }" class="router-link"
                ><span>{{ $t('navbar.donate') }}</span></router-link
            >
...
export default {
    ...
    methods: {
        ...
        onResize() {
            this.showIcons =
                window.innerWidth < 1000 || window.innerWidth >= 1250
        },
    },
    watch: {
        $route() {
...
.navbar-container {
    ...
    &.scrolled {
        ...
        box-shadow:
            0 6px 38px -18px rgba(0, 0, 0, 0.3),
