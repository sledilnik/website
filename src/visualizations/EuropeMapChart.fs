...
let redCountries =
    Map.ofList
        [
            ...
            ("ETH", "")
            ("PHL", "")
            ("FRA", "vse administrativne enote celinske Francije in vsa čezmorska ozemlja")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "vse administrativne enote, razen administrativnih enot Severnoegejski otoki, Epir in Jonski otoki")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativne enote Oslo, Rogaland in Viken")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
