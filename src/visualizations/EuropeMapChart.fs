...
let redCountries =
    Map.ofList
        [
            ...
            ("GMB", "")
            ("GHA", "")
            ("GRC", "administrativni enoti Atika in Zahodna Grčija")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("IRN", "")
            ("IRL", "")
            ("ITA", "vse administrativne enote, razen administrativnih enot Dolina Aoste, Sardinija in Sicilija")
            ("ISR", "")
            ("JAM", "")
            ("YEM", "")
            ("JOR", "")
            ...
            ("LCA", "")
            ("VCT", "")
            ("ESP", "vse administrativne enote, razen administrativnih enot Extremadura, Balearski otoki in Kanarski otoki")
            ("SWE", "")
            ("CHE", "")
            ("TJK", "")
            ("TZA", "")
