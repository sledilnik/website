...
let redCountries =
    Map.ofList
        [
            ...
            ("ARG", "")
            ("ARM", "")
            ("AUT", "vse administrativne enote, razen administrativne enote Gradiščanske")
            ("AZE", "")
            ("BHS", "")
            ("BHR", "")
            ("BGD", "")
            ...
            ("CYP", "")
            ("TCD", "")
            ("CZE", "vse administrativne enote, razen administrativne enote Severovychod")
            ("CHL", "")
            ("MNE", "")
            ("DNK", "")
            ("DJI", "")
            ...
            ("ETH", "")
            ("PHL", "")
            ("FRA", "vse administrativne enote celinske Francije in vsa čezmorska ozemlja, razen čezmorskega ozemlja Mayotte")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "vse administrativne enote, razen administrativnih enot Severnoegejski otoki in Peloponez")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("IRQ", "")
            ("IRN", "")
            ("IRL", "administrativna enota Vzhodna in Osrednja regija")
            ("ITA", "vse administrativne enote, razen administrativnih enot Furlanija-Julijska krajina, Molize in Sardinija")
            ("JAM", "")
            ("YEM", "")
            ("JOR", "")
            ("ZAF", "")
            ...
            ("SDN", "")
            ("SUR", "")
            ("ESP", "vse administrativne enote, razen administrativnih enot Asturija, Ceuta, Extremadura, Galicija, Balearski otoki, Kanarski otoki, Murcia in Valencija")
            ("SWE", "")
            ("CHE", "")
            ("LKA", "")
            ("TJK", "")
