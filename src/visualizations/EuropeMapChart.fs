...
let redCountries =
    Map.ofList
        [
            ...
            ("ARG", "")
            ("ARM", "")
            ("AUT", "administrativna enota Vorarlberg")
            ("AZE", "")
            ("BHS", "")
            ("BHR", "")
            ("BGD", "")
            ...
            ("ETH", "")
            ("PHL", "")
            ("FRA", "administrativne enote Ile-de-France, Centre-Val de Loire, Bourgogne-Franche-Comté, Normandie, Hauts-de-France, Grand Est, Pays de la Loire, Bretagne, Occitanie in Auvergne-Rhône-Alpes ter čezmorski ozemlji Guadeloupe in La Réunion <br>temno rdeča: administrativna enota čezmorsko ozemlje Guyane")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "administrativne enote Attiki, Kriti, Kentriki Makedonia, Dytiki Makedonia, Ipeiros, Thessalia, Ionia Nisia, Dytiki Ellada in Sterea Ellada")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("HTI", "")
            ("HND", "")
            ("HRV", "administrativne enote Panonska Hrvatska, Grad Zagreb in Sjeverna Hrvatska")
            ("IND", "")
            ("IDN", "")
            ("IRQ", "")
            ("IRN", "")
            ("IRL", "")
            ("ITA", "administrativne enote Valle d’Aosta, Basilicata in Calabria")
            ("YEM", "")
            ("JOR", "")
            ("ZAF", "")
            ("SSD", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativne enote Agder, Troms og Finnmark in Vestfold og Telemark")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ...
            ("SUR", "")
            ("LCA", "")
            ("ESP", "administrativne enote Andalucía, Aragón, Castilla y León, Castilla-La Mancha, Ceuta, La Rioja, Madrid, Melilla in País Vasco")
            ("SWE", "")
            ("LKA", "")
            ("TJK", "")
            ("TZA", "")
