...
let redCountries =
    Map.ofList
        [
            ...
            ("CHL", "")
            ("MNE", "")
            ("DNK", "administrativna enota Hovedstaden")
            ("DOM", "")
            ("EGY", "")
            ("ECU", "")
            ("GNQ", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativni enoti Oslo in Viken")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ...
            ("LCA", "")
            ("VCT", "")
            ("ESP", "vse administrativne enote, razen administrativnih enot Kantabrija, Extremadura, Galicija, Balearski otoki, La Rioja in Navarra")
            ("SWE", "")
            ("CHE", "")
            ("TJK", "")
            ("TZA", "")
