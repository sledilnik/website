...
let redCountries =
    Map.ofList
        [
            ...
            ("ARG", "")
            ("ARM", "")
            ("AUT", "administrativne enote Kärnten, Steiermark, Oberösterreich, Tirol in Vorarlberg")
            ("AZE", "")
            ("BHS", "")
            ("BHR", "")
            ("BGD", "")
            ...
            ("CYP", "")
            ("TCD", "")
            ("CZE", "administrativne enote Jihozápad, Severozápad, Jihovýchod, Střední Morava in Moravskoslezsko")
            ("CHL", "")
            ("MNE", "")
            ("DNK", "administrativne enote Hovedstaden, Sjælland, Midtjylland in Nordjylland")
            ("DJI", "")
            ("EGY", "")
            ("ECU", "")
            ("GNQ", "")
            ...
            ("ETH", "")
            ("PHL", "")
            ("FRA", "administrativne enote Centre-Val de Loire, Bourgogne-Franche-Comté, Normandie, Hauts-de-France, Grand Est, Pays de la Loire, Bretagne, Nouvelle-Aquitaine, Occitanie, Auvergne-Rhône-Alpes in Provence-Alpes-Côte d’Azur ter čezmorski ozemlji Guadeloupe in La Réunion<br>temno rdeča: administrativna enota Ile-de-France ")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "vse administrativne enote, razen administrativnih enot Voríou Eyéou in Peloponnísou")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("HTI", "")
            ("HND", "")
            ("HRV", "administrativna enota Panonska Hrvatska, Jadranska Hrvatska in Grad Zagreb<br>temno rdeča: administrativna enota Sjeverna Hrvatska")
            ("IND", "")
            ("IDN", "")
            ("IRQ", "")
            ("IRN", "")
            ("ITA", "administrativne enote Piemonte, Valle d’Aosta, Lombardia, Campania, Puglia, Basilicata, Calabria, Sicilia, Bolzano/Bozen, Emilia-Romagna, Toscana, Marche in Lazio")
            ("YEM", "")
            ("JOR", "")
            ("ZAF", "")
            ("SSD", "")
            ...
            ("NGA", "")
            ("NIC", "")
            ("NLD", "administrativne enote Groningen, Friesland, Drenthe, Overijssel, Gelderland, Flevoland, Utrecht in Noord-Holland<br>temno rdeče: administrativne enote Zuid-Holland, Zeeland, Noord-Brabant, Limburg")
            ("NOR", "administrativni enoti Oslo in Vestfold og Telemark")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ("PRY", "")
            ("PER", "")
            ("POL", "vse administrativne enote, razen administrativne enote Podkarpackie")
            ("RUS", "")
            ("SLV", "")
            ("SMR", "")
            ("STP", "")
            ...
            ("SUR", "")
            ("LCA", "")
            ("ESP", "administrativne enote Andalucía, Aragón, Castilla y León, Castilla-La Mancha, Cataluña, La Rioja, Madrid, Melilla, Navarra in País Vasco")
            ("SWE", "administrativna enota Norra Mellansverige<br>temno rdeče: administrativne enote Stockholm, Östra Mellansverige, Småland med öarna, Sydsverige, Västsverige, Mellersta Norrland in Övre Norrland")
            ("CHE", "")
            ("LKA", "")
            ("TJK", "")
            ("TZA", "")
