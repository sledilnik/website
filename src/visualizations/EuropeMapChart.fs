...
let redCountries =
    Map.ofList
        [
            ...
            ("ARG", "")
            ("ARM", "")
            ("AUT", "vse administrativne enote, razen administrativne enote Predarlska")
            ("AZE", "")
            ("BAH", "")
            ("BHR", "")
            ("BGD", "")
            ...
            ("CHL", "")
            ("MNE", "")
            ("DNK", "administrativni enoti Hovedstaden in Syddanmark")
            ("DOM", "")
            ("EGY", "")
            ("ECU", "")
            ("GNQ", "")
            ...
            ("ETH", "")
            ("PHL", "")
            ("FIN", "administrativni enoti Helsinki – Uusimaa in Åland")
            ("FRA", "vse administrativne enote celinske Francije in vsa čezmorska ozemlja, razen čezmorskih ozemelj Guyane in Martinique ")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "administrativne enote Atika, Osrednja Makedonija, Zahodna Grčija, Osrednja Grčija in Peloponez")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("IRN", "")
            ("IRL", "")
            ("ITA", "vse administrativne enote, razen administrativnih enot Sardinija in Sicilija")
            ("ISR", "")
            ("JAM", "")
            ("YEM", "")
            ("JOR", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativna enota Oslo")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ...
            ("PER", "")
            ("POL", "")
            ("PRT", "vse administrativne enote in vsa čezmorska ozemlja, razen avtonomne regije Azori")
            ("ROU", "")
            ("RUS", "")
            ("SLV", "")
            ("SMR", "")
            ...
            ("LCA", "")
            ("VCT", "")
            ("ESP", "administrativne enote Kantabrija, Extremadura, Galicija, Balearski otoki, La Rioja, Navarra")
            ("SWE", "")
            ("CHE", "")
            ("TJK", "")
            ("TZA", "")
