...
let redCountries =
    Map.ofList
        [
            ...
            ("CHL", "")
            ("MNE", "")
            ("DNK", "administrativne enote Hovedstaden, Sjælland in Syddanmark")
            ("DOM", "")
            ("EGY", "")
            ("ECU", "")
            ("GNQ", "")
            ...
            ("ETH", "")
            ("PHL", "")
            ("FIN", "vse administrativne enote, razen administrativne enote Severna in Vzhodna Finska ")
            ("FRA", "vse administrativne enote, razen administrativna enota Sardinija")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "")
            ...
            ("ITA", "vse administrativne enote, razen administrativni enoti Sardinija in Dolina Aoste")
            ("ISR", "")
            ("JAM", "")
            ("YEM", "")
            ("JOR", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativne enote Oslo, Vestfold og Telemark in Viken")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ...
            ("SUR", "")
            ("LCA", "")
            ("ESP", "vse administrativne enote, razen administrativnih enot Kantabrija, Extremadura, Galicija, Balearski otoki, Murcia in Navarra")
            ("SWE", "")
            ("CHE", "")
            ("TJK", "")
            ("TZA", "")
