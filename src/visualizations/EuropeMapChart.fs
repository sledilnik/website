...
let redCountries =
    Map.ofList
        [
            ...
            ("CHL", "")
            ("MNE", "")
            ("DNK", "administrativni enoti Hovedstaden in Nordjylland")
            ("DJI", "")
            ("EGY", "")
            ("ECU", "")
            ("GNQ", "")
            ...
            ("GMB", "")
            ("GHA", "")
            ("GRC", "vse administrativne enote, razen administrativnih enot Severnoegejski otoki, Južnoegejski otoki, Jonski otoki in Peloponez")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativni enoti Oslo in Agder")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
