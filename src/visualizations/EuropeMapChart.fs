...
let greenCountries =
    Map.ofList
        [ 
            ...
            ("SMR", "")
            ("SVK", "")
            ("ESP", " (Andaluzija, Asturija, Ceuta, Extremandura, Galicija, Kanarski otoki, Kastilja-Manča, Melilla)")
            ("URY", "")
            ("VAT", "")
            ("GBR", "") 
        ]
...
let redCountries =
    Map.ofList
        [ 
            ...
            ("MAF", "")
            ("SUR", "")
            ("ESP", " (Aragonija, Baskija, Katalonija, Navarra)")
            ("TCA", "")
            ("CPV", "")
            ("USA", "")
            ("ARE", "")
...
let importedDate = DateTime(2020, 8, 16)
