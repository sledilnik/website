...
let redCountries =
    Map.ofList
        [
            ...
            ("ARG", "")
            ("ARM", "")
            ("AUT", "administrativni enoti Tirolska in Predarlska")
            ("AZE", "")
            ("BHS", "")
            ("BHR", "")
            ("BGD", "")
            ...
            ("CYP", "")
            ("TCD", "")
            ("CZE", "administrativna enota Moravskoslezsko")
            ("CHL", "")
            ("MNE", "")
            ...
            ("ETH", "")
            ("PHL", "")
            ("FRA", "administrativne enote Ile-de-France, Centre-Val de Loire, Bourgogne-Franche-Comté, Normandie, Hauts-de-France, Grand Est, Pays de la Loire, Bretagne, Occitanie, Auvergne-Rhône-Alpes in Provence-Alpes-Côte d’Azur ter čezmorski ozemlji Guadeloupe in La Réunion <br>temno rdeča: administrativna enota čezmorsko ozemlje Guyane")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "administrativne enote Attiki, Notio Aigaio, Kriti, Kentriki Makedonia, Dytiki Makedonia, Ipeiros, Thessalia, Dytiki Ellada, Sterea Ellada")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("IRQ", "")
            ("IRN", "")
            ("ITA", "administrativne enote Valle d’Aosta, Campania, Puglia, Basilicata, Calabria, in Toscana")
            ("YEM", "")
            ("JOR", "")
            ("ZAF", "")
            ("SSD", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativni enoti Agder in Vestfold og Telemark")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ("PRY", "")
            ("PER", "")
            ("POL", "administrativni enoti Wielkopolskie in Opolskie")
            ("RUS", "")
            ("SLV", "")
            ("SAU", "")
            ("SEN", "")
            ...
            ("SUR", "")
            ("LCA", "")
            ("ESP", "administrativne enote Andalucía, Aragón, Castilla y León, Castilla-La Mancha, La Rioja, Madrid, Melilla, Murcia in País Vasco")
            ("SWE", "")
            ("CHE", "")
            ("LKA", "")
            ("TJK", "")
