...
let redCountries =
    Map.ofList
        [
            ...
            ("CHL", "")
            ("MNE", "")
            ("DNK", "administrativna enota: vse razen Ferski otoki in Grenlandija")
            ("DOM", "")
            ("EGY", "")
            ("ECU", "")
            ("GNQ", "")
            ...
            ("GMB", "")
            ("GHA", "")
            ("GRC", "vse administrativne enote, razen administrativnih enot Južnoegejski otoki, Kreta, Epir in Jonski otoki")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativni enoti: Oslo, Rogaland, Viken")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
