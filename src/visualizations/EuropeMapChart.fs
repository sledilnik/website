...
let redCountries =
    Map.ofList
        [
            ...
            ("GMB", "")
            ("GHA", "")
            ("GRC", "vse administrativne enote, razen administrativnih enot Severnoegejski otoki, Južnoegejski otoki in Jonski otoki")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativne enote Oslo in Viken")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ...
            ("SUR", "")
            ("VCT", "")
            ("ESP", "vse administrativne enote, razen administrativnih enot Extremadura, Galicija, Balearski otoki, Kanarski otoki, Murcia in Valencija")
            ("SWE", "")
            ("CHE", "")
            ("TJK", "")
            ("TZA", "")
