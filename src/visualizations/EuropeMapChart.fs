...
let redCountries =
    Map.ofList
        [
            ...
            ("ETH", "")
            ("PHL", "")
            ("FIN", "administrativna enota Helsinki – Uusimaa")
            ("FRA", "vse administrativne enote celinske Francije in vsa čezmorska ozemlja, razen čezmorskih ozemelj Guadeloupe, Martinique in La Reunion")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "administrativna enota Atika")
            ("GEO", "")
            ("GUY", "")
            ("GTM", "")
            ("GIN", "")
            ...
            ("IRN", "")
            ("IRL", "")
            ("ITA", "vse administrativne enote, razen administrativne enote Dolina Aoste")
            ("ISR", "")
            ("JAM", "")
            ("YEM", "")
            ("JOR", "")
