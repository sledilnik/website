...
let redCountries =
    Map.ofList
        [
            ...
            ("ETH", "")
            ("PHL", "")
            ("FIN", "administrativne enote Uusimaa, Južna Finska in Zahodna Finska")
            ...
            ("SUR", "")
            ("LCA", "")
            ("ESP", "vse administrativne enote, razen administrativnih enot Extremadura, Galicija, Balearski otoki in Valencija")
            ("SWE", "")
            ("CHE", "")
            ("TJK", "")
            ("TZA", "")
