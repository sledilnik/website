...
let greenCountries =
    Map.ofList
        [
            ...
            ("AUS", "")
            ("AUT", "")
            ("BEL", "na zelenem seznamu Flandrija in Valonija <br>na oranžnem seznamu Bruselj")
            ("BGR", "")
            ("BIH", "")
            ("BRN", "")
            ("CZE", "")
            ("MNE", "")
            ("DNK", "na zelenem seznamu administrativne enote Syddanmark, Midtjylland, Nordjylland in Sjælland <br>na oranžnem seznamu Hovestaden")
            ("EST", "")
            ("FIN", "")
            ("FRA", "na oranžnem seznamu čezmorski ozemlji Guadeloupe in Martinique, ostale enote na zelenem seznamu<br>na rdečem seznamu: čezmorsko ozemlje La Reunion <br>na temno rdečem seznamu: čezmorsko ozemlje Guyane")
            ("GRC", "na zelenem seznamu vse administrativne enote razen enoti Attiki in Notio Aigaio, ki sta na oranžnem seznamu")
            ("HRV", "")
            ("HKG", "")
            ("ISL", "")
            ("ITA", "")
            ...
            ("MCO", "")
            ("DEU", "")
            ("NLD", "na zelenem seznamu administrativne enote Drenthe, Flevoland, Friesland, Groningen in Limburg, ostale enote na oranžnem seznamu")
            ("NOR", "na zelenem seznamu vse administrativne enote razen enot Rogaland in Agder, ki sta na oranžnem seznamu")
            ("NZL", "")
            ("POL", "")
            ...
            ("SVK", "")
            ("SRB", "")
            ("SWE", "na zelenem seznamu administrativne enote Mallersta Norrland, Östra Mellansverige, Sydsverige, Västsverige in Stockholm, ostale enote na oranžnem seznamu")
            ("CHE", "")
            ("THA", "")
            ("TWN", "")
            ("VAT", "")
...
let redCountries =
    Map.ofList
        [
            ...
            ("CAF", "")
            ("MAF", "")
            ("ESP", "na rdečem seznamu administrativne enote Andaluzija, La Rioja, Kantabrija, Comunitat Valenciana, Aragon, Katalonija, Melila in Kanarski otoki<br>na zelenem seznamu administrativna enota Ciudad de Ceuta, ostale enote na oranžnem seznamu")
            ("TJK", "")
            ("TGO", "")
            ("TUR", "")
            ("TKM", "")
