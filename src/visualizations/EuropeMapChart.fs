...
let redCountries =
    Map.ofList
        [
            ...
            ("ETH", "")
            ("PHL", "")
            ("FIN", "administrativni enoti Uusimaa in Južna Finska")
            ("FRA", "vse administrativne enote celinske Francije in vsa čezmorska ozemlja, razen čezmorskega ozemlja Guyane")
            ("GAB", "")
            ("GMB", "")
            ("GHA", "")
            ("GRC", "")
            ...
            ("ITA", "vse administrativne enote, razen administrativna enota Sardinija")
            ("ISR", "")
            ("JAM", "")
            ("YEM", "")
            ("JOR", "")
            ...
            ("NIC", "")
            ("NLD", "")
            ("NOR", "administrativne enote Oslo, Rogaland, Vestfold og Telemark in Viken")
            ("OMN", "")
            ("PAK", "")
            ("PAN", "")
            ("PNG", "")
            ...
            ("SUR", "")
            ("LCA", "")
            ("ESP", "vse administrativne enote, razen administrativnih enot Kantabrija, Extremadura, Galicija, Balearski otoki, Murcia in Valencija")
            ("SWE", "")
            ("CHE", "")
            ("TJK", "")
            ("TZA", "")
