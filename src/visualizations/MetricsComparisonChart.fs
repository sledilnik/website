...
module Metrics  =
    let initial = [
        ...
        // DISABLED: { Metric=VacAdministeredToday;  Color="#189a73"; Visible=false; Type=Today;  Id="vaccinationAdministered" }
        // DISABLED: { Metric=VacAdministered2Today; Color="#0e5842"; Visible=false; Type=Today;  Id="vaccinationAdministered2nd" }
        ...
        // DISABLED: { Metric=VacAdministeredToDate; Color="#189a73"; Visible=true;  Type=ToDate; Id="vaccinationAdministered" }
        // DISABLED: { Metric=VacAdministered2ToDate;Color="#0e5842"; Visible=true;  Type=ToDate; Id="vaccinationAdministered2nd" }
