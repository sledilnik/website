...
module Dictionaries =
    ...
    // SURS 2021-H1: see dict-region.csv
    let regions =
        [ "si",  "SLOVENIJA",  Some 2108977
          "ms",  "Pomurska",  Some 114725
          "mb",  "Podravska",  Some 328469
          "sg",  "Koroška",  Some 70635
          "ce",  "Savinjska",  Some 258908
          "za",  "Zasavska",  Some 57204
          "kk",  "Posavska",  Some 75928
          "nm",  "Jugovzhodna Slovenija",  Some 145923
          "lj",  "Osrednjeslovenska",  Some 555948
          "kr",  "Gorenjska",  Some 211069
          "po",  "Primorsko-notranjska",  Some 53254
          "ng",  "Goriška",  Some 118525
          "kp",  "Obalno-kraška",  Some 118389
          "unknown", "TUJINA", None
    ...
    // SURS 2021-H1: see dict-municipality.csv
    let municipalities =
        [
            "ajdovščina","Ajdovščina","SI-001",19704
            "ankaran","Ankaran/Ancarano","SI-213",3261
            "apače","Apače","SI-195",3556
            "beltinci","Beltinci","SI-002",8068
            "benedikt","Benedikt","SI-148",2614
            "bistrica_ob_sotli","Bistrica ob Sotli","SI-149",1356
            "bled","Bled","SI-003",8217
            "bloke","Bloke","SI-150",1616
            "bohinj","Bohinj","SI-004",5611
            ...
            "celje","Celje","SI-011",49007
            "cerklje_na_gorenjskem","Cerklje na Gorenjskem","SI-012",7859
            "cerknica","Cerknica","SI-013",11691
            "cerkno","Cerkno","SI-014",4547
            "cerkvenjak","Cerkvenjak","SI-153",2171
            "cirkulane","Cirkulane","SI-196",2378
            "črenšovci","Črenšovci","SI-015",3972
            "črna_na_koroškem","Črna na Koroškem","SI-016",3252
            "črnomelj","Črnomelj","SI-017",14308
            "destrnik","Destrnik","SI-018",2647
            "divača","Divača","SI-019",4334
            "dobje","Dobje","SI-154",934
            "dobrepolje","Dobrepolje","SI-020",3882
            "dobrna","Dobrna","SI-155",2250
            "dobrova-polhov_gradec","Dobrova - Polhov Gradec","SI-021",7843
            "dobrovnik","Dobrovnik/Dobronak","SI-156",1293
            "dol_pri_ljubljani","Dol pri Ljubljani","SI-022",6378
            "dolenjske_toplice","Dolenjske Toplice","SI-157",3593
            "domžale","Domžale","SI-023",36683
            "dornava","Dornava","SI-024",2896
            "dravograd","Dravograd","SI-025",8844
            "duplek","Duplek","SI-026",6959
            "gorenja_vas-poljane","Gorenja vas - Poljane","SI-027",7665
            "gorišnica","Gorišnica","SI-028",4161
            "gorje","Gorje","SI-207",2769
            "gornja_radgona","Gornja Radgona","SI-029",8474
            "gornji_grad","Gornji Grad","SI-030",2480
            "gornji_petrovci","Gornji Petrovci","SI-031",2040
            "grad","Grad","SI-158",2087
            "grosuplje","Grosuplje","SI-032",21398
            "hajdina","Hajdina","SI-159",3938
            "hoče-slivnica","Hoče - Slivnica","SI-160",11720
            "hodoš","Hodoš/Hodos","SI-161",369
            "horjul","Horjul","SI-162",2985
            "hrastnik","Hrastnik","SI-034",9058
            "hrpelje-kozina","Hrpelje - Kozina","SI-035",4851
            "idrija","Idrija","SI-036",11735
            "ig","Ig","SI-037",7656
            "ilirska_bistrica","Ilirska Bistrica","SI-038",13379
            "ivančna_gorica","Ivančna Gorica","SI-039",17538
            "izola","Izola/Isola","SI-040",16737
            "jesenice","Jesenice","SI-041",21679
            "jezersko","Jezersko","SI-163",666
            "juršinci","Juršinci","SI-042",2421
            "kamnik","Kamnik","SI-043",29989
            "kanal","Kanal","SI-044",5289
            "kidričevo","Kidričevo","SI-045",6539
            "kobarid","Kobarid","SI-046",4032
            "kobilje","Kobilje","SI-047",540
            "kočevje","Kočevje","SI-048",15644
            "komen","Komen","SI-049",3655
            "komenda","Komenda","SI-164",6444
            "koper","Koper/Capodistria","SI-050",53292
            "kostanjevica_na_krki","Kostanjevica na Krki","SI-197",2446
            "kostel","Kostel","SI-165",691
            "kozje","Kozje","SI-051",3030
            "kranj","Kranj","SI-052",57185
            "kranjska_gora","Kranjska Gora","SI-053",7522
            "križevci","Križevci","SI-166",3549
            "krško","Krško","SI-054",25904
            "kungota","Kungota","SI-055",4844
            "kuzma","Kuzma","SI-056",1624
            "laško","Laško","SI-057",13123
            "lenart","Lenart","SI-058",8512
            "lendava","Lendava/Lendva","SI-059",10486
            "litija","Litija","SI-060",15743
            "ljubljana","Ljubljana","SI-061",294464
            "ljubno","Ljubno","SI-062",2576
            "ljutomer","Ljutomer","SI-063",11233
            "log-dragomer","Log - Dragomer","SI-208",3620
            "logatec","Logatec","SI-064",14681
            "loška_dolina","Loška dolina","SI-065",3703
            "loški_potok","Loški Potok","SI-066",1816
            "lovrenc_na_pohorju","Lovrenc na Pohorju","SI-167",2988
            "luče","Luče","SI-067",1454
            "lukovica","Lukovica","SI-068",5888
            "majšperk","Majšperk","SI-069",4060
            "makole","Makole","SI-198",2051
            "maribor","Maribor","SI-070",113778
            "markovci","Markovci","SI-168",4025
            "medvode","Medvode","SI-071",16811
            "mengeš","Mengeš","SI-072",8411
            "metlika","Metlika","SI-073",8480
            "mežica","Mežica","SI-074",3598
            "miklavž_na_dravskem_polju","Miklavž na Dravskem polju","SI-169",6996
            "miren-kostanjevica","Miren - Kostanjevica","SI-075",5029
            "mirna","Mirna","SI-212",2683
            "mirna_peč","Mirna Peč","SI-170",3034
            "mislinja","Mislinja","SI-076",4520
            "mokronog-trebelno","Mokronog - Trebelno","SI-199",3164
            "moravče","Moravče","SI-077",5469
            "moravske_toplice","Moravske Toplice","SI-078",5958
            "mozirje","Mozirje","SI-079",4244
            "murska_sobota","Murska Sobota","SI-080",18622
            "muta","Muta","SI-081",3417
            "naklo","Naklo","SI-082",5431
            "nazarje","Nazarje","SI-083",2611
            "nova_gorica","Nova Gorica","SI-084",31845
            "novo_mesto","Novo mesto","SI-085",37398
            "odranci","Odranci","SI-086",1619
            "oplotnica","Oplotnica","SI-171",4154
            "ormož","Ormož","SI-087",11886
            "osilnica","Osilnica","SI-088",327
            "pesnica","Pesnica","SI-089",7508
            "piran","Piran/Pirano","SI-090",18457
            "pivka","Pivka","SI-091",6190
            "podčetrtek","Podčetrtek","SI-092",3614
            "podlehnik","Podlehnik","SI-172",1853
            "podvelka","Podvelka","SI-093",2365
            "poljčane","Poljčane","SI-200",4467
            "polzela","Polzela","SI-173",6321
            "postojna","Postojna","SI-094",16675
            "prebold","Prebold","SI-174",5210
            "preddvor","Preddvor","SI-095",3780
            "prevalje","Prevalje","SI-175",6800
            "ptuj","Ptuj","SI-096",23611
            "puconci","Puconci","SI-097",5904
            "rače-fram","Rače - Fram","SI-098",7623
            "radeče","Radeče","SI-099",4164
            "radenci","Radenci","SI-100",5098
            "radlje_ob_dravi","Radlje ob Dravi","SI-101",6164
            "radovljica","Radovljica","SI-102",19195
            "ravne_na_koroškem","Ravne na Koroškem","SI-103",11289
            "razkrižje","Razkrižje","SI-176",1265
            "rečica_ob_savinji","Rečica ob Savinji","SI-209",2355
            "renče-vogrsko","Renče - Vogrsko","SI-201",4383
            "ribnica","Ribnica","SI-104",9644
            "ribnica_na_pohorju","Ribnica na Pohorju","SI-177",1142
            "rogaška_slatina","Rogaška Slatina","SI-106",11323
            "rogašovci","Rogašovci","SI-105",3114
            "rogatec","Rogatec","SI-107",3138
            "ruše","Ruše","SI-108",7055
            "selnica_ob_dravi","Selnica ob Dravi","SI-178",4562
            "semič","Semič","SI-109",3887
            "sevnica","Sevnica","SI-110",17639
            "sežana","Sežana","SI-111",13802
            "slovenj_gradec","Slovenj Gradec","SI-112",16595
            "slovenska_bistrica","Slovenska Bistrica","SI-113",25949
            "slovenske_konjice","Slovenske Konjice","SI-114",15263
            "sodražica","Sodražica","SI-179",2249
            "solčava","Solčava","SI-180",529
            "središče_ob_dravi","Središče ob Dravi","SI-202",1919
            ...
            "šenčur","Šenčur","SI-117",8829
            "šentilj","Šentilj","SI-118",8375
            "šentjernej","Šentjernej","SI-119",7225
            "šentjur","Šentjur","SI-120",19378
            "šentrupert","Šentrupert","SI-211",2898
            "škocjan","Škocjan","SI-121",3429
            "škofja_loka","Škofja Loka","SI-122",23462
            "škofljica","Škofljica","SI-123",11657
            "šmarje_pri_jelšah","Šmarje pri Jelšah","SI-124",10375
            "šmarješke_toplice","Šmarješke Toplice","SI-206",3521
            "šmartno_ob_paki","Šmartno ob Paki","SI-125",3278
            "šmartno_pri_litiji","Šmartno pri Litiji","SI-194",5661
            "šoštanj","Šoštanj","SI-126",8847
            "štore","Štore","SI-127",4477
            "tabor","Tabor","SI-184",1670
            "tišina","Tišina","SI-010",3965
            "tolmin","Tolmin","SI-128",11018
            "trbovlje","Trbovlje","SI-129",16024
            "trebnje","Trebnje","SI-130",13310
            "trnovska_vas","Trnovska vas","SI-185",1374
            "trzin","Trzin","SI-186",3925
            "tržič","Tržič","SI-131",15054
            "turnišče","Turnišče","SI-132",3190
            "velenje","Velenje","SI-133",33715
            "velika_polana","Velika Polana","SI-187",1380
            "velike_lašče","Velike Lašče","SI-134",4520
            "veržej","Veržej","SI-188",1344
            "videm","Videm","SI-135",5684
            "vipava","Vipava","SI-136",5767
            "vitanje","Vitanje","SI-137",2267
            "vodice","Vodice","SI-138",4983
            "vojnik","Vojnik","SI-139",9009
            "vransko","Vransko","SI-189",2646
            "vrhnika","Vrhnika","SI-140",17613
            "vuzenica","Vuzenica","SI-141",2649
            "zagorje_ob_savi","Zagorje ob Savi","SI-142",16379
            "zavrč","Zavrč","SI-143",1527
            "zreče","Zreče","SI-144",6600
            "žalec","Žalec","SI-190",21528
            "železniki","Železniki","SI-146",6699
            "žetale","Žetale","SI-191",1303
            "žiri","Žiri","SI-147",4981
            "žirovnica","Žirovnica","SI-192",4465
            "žužemberk","Žužemberk","SI-193",4741
        ]
