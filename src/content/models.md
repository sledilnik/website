...
Mlada sekcija Statističnega društva Slovenije je skupaj s sledilnik.org 21. aprila 2020 organizirala [okroglo mizo](https://stat-d.si/2020/04/17/4-srecanje-mlade-sekcije-modeliranje-in-statisticni-vidiki-covid-19-v-sloveniji/), ki sta jo vodila dr. Andrej Srakar in dr. Ana Slavec. STA je dogodek [prenašala v živo](https://youtu.be/ZzIbNxvGdo8?t=117) več kot 800 udeležencem.
